...
namespace VS_SLG6.Services.Validators
{
    public class ProductRatingValidator : GenericValidator<ProductRating>, IValidator<ProductRating>
    {
        ...
        public override ValidationModel<bool> CanAdd(ProductRating obj)
        {
            ...
            CheckUserAuthorization(obj.User.Id);
            if (!_validationModel.Value) return _validationModel;
        ...
        public override ValidationModel<bool> CanEdit(ProductRating obj)
        {
            _validationModel = IsObjectValid(obj);
            if (!_validationModel.Value) return _validationModel;
            CheckUserAuthorization(obj.User.Id);
        ...
        public override ValidationModel<bool> CanDelete(ProductRating obj)
        {
            _validationModel = IsObjectValid(obj);
            if (!_validationModel.Value) return _validationModel;
            CheckUserAuthorization(obj.User.Id);
        ...
        public override ValidationModel<bool> IsObjectValid(ProductRating obj)
        {
